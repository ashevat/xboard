	...
	<div class="span12 widget-box">
		...
		<div class="widget-content">
			<p>Your name is the first thing people hear when you talk, pitch or
				...
				card. A good name will keep your audience focused on your message. A
				mediocre name will not catch anyone’s attention and a bad name will
				hurt you, and there’s no reason to go down that path when you can
				avoid it.</p>
			<p>Coming up with a name is a relatively simple process. Before you
				...
				is helpful to use a thesaurus or dictionary in order to translate an
				English word into other languages like Latin.</p>
			<p>Once your list is compiled enter in into the startup name text box
				below in order to check the domain availability</p>
		</div>
	</div>
	...
	<div class="row-fluid">
		...
		<div class="widget-box">
			...
			<input type="text" id="search_box" /> <br /> <input
				...
				value="Search" /> <input class="btn btn-success btn-large"
			...
			<div class="widget-box">
				...
				<div class="widget-content">
					...
					<p>
						...
						to check if there are any interesting word combinations available
						or <a href="http://wordoid.com/">http://wordoid.com/</a> to
						generate some made-up words.
					</p>
				</div>
			</div>
		</div>
