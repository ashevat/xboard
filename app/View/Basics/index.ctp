            ...
            <div class="row-fluid">
            	...
            	<h2>Your startup dashboard</h2>
		            <p>Building a startup is a complex business. Entrepreneurs need to be visionaries, implementers, marketers and sales-persons. They also need to be savy business men from day one and understand their key success metrix. </p>
					   <p>StartHub is here to help entrepreneurs become successful by giving them a central place for their startup - helping them focus on the right things, provide guidelines and best practices on marketing, technology and more as well as given them and there investors a single dashboard to measure success. </p>
		            <p>
